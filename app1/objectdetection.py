...
from app1.groundingdino.util.inference import (
    load_model,
    load_image,
    predict,
    annotate,
...
def objectdetection():
    CONFIG_PATH = "app1/groundingdino/config/GroundingDINO_SwinT_OGC.py"
    WEIGHTS_PATH = "app1/weights/groundingdino_swint_ogc.pth"
    BOX_TRESHOLD = 0.35
    TEXT_TRESHOLD = 0.25
    upload_path = "app1/uploads/"
